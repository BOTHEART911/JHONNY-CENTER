/* Service Worker — Jhonny Perdomo · Call Center
...
const CACHE_PREFIJO = NS_SW + '-center-';
...
self.addEventListener('fetch', (e) => {
  ...
  // El backend y los recursos externos van SIEMPRE a la red: lo que se marca
  // tiene que llegar, y una respuesta cacheada aquí sería un dato viejo.
