/* ============================================================================
 * CAPA 12 · ANTI DOBLE CLIC  (app CENTER · call center)   ·   31/07/2026
 * ----------------------------------------------------------------------------
 * Misma capa que ya está publicada en la app pública. Aquí va ajustada a este
 * repo: no toca style.css ni app.js.
 *
...
(function () {
  ...
  /* ---------------------------------------------------------------------
     ...
     --------------------------------------------------------------------- */
  try {
    var ESPERA = ['.btn', 'button', '.rc-btn', '.rcard', '.ac-t', '.check', '.chk', '.combo-btn', '.combo-item', '.combo-fil', '.var-chip', '.ab-btn', '.card', '.area'];
    var reglas = '';
  ...
  /* --- parche del asignador `onclick` -------------------------------------
     ...
     (16 en app.js): quedan cubiertas de una. El radio de los bloques usa
     addEventListener: ese lo cubre el escudo de pantalla. */
  var objetivos = [];
